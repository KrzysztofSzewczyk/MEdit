...
/**
 * This class is small, but it was needed to split it away
 * from MainFrame to keep code climate and internal structure
 * of MEdit. It's setting up bottombar containing information about current opened document.
...
public class BottombarActionManager {
	...
	/**
	 * MainFrame instance used by this class to create bottombar
	 * and it's text.
	 */
	...
	/**
	 * This is function that is setting up bottom bar in
	 * internal MainFrame instance, that is passed to this class
	 * using constructor.
	 */
