...
public class LanguageActionManager {
	...
	public void SetUp(final JMenu parent, final CodeCompletionActionManager ccam) {
		...
		final JMenuItem mntmBpp = new JMenuItem("B++ (MEdit scripting language)"); // Yay, we are there!
		...
		final JMenuItem mntmClojure = new JMenuItem("Clojure"); // It looks like lisp
		final JMenu mnD = new JMenu("D");
		final JMenuItem mntmDart = new JMenuItem("Dart");
		final JMenuItem mntmDelphi = new JMenuItem("Delphi");
		final JMenuItem mntmDocker = new JMenuItem("Docker"); // Like it!
		final JMenuItem mntmDtd = new JMenuItem("DTD");
		final JMenuItem mntmD = new JMenuItem("D");
		final JMenuItem mntmFortan = new JMenuItem("Fortan"); // Try using it for graphics
		final JMenuItem mntmGroovy = new JMenuItem("Groovy");
		final JMenu mnH = new JMenu("H");
		final JMenuItem mntmHtaccess = new JMenuItem("HTAccess"); // This one gave me so much stress
		final JMenuItem mntmHosts = new JMenuItem("Hosts");
		final JMenuItem mntmHtml = new JMenuItem("HTML"); // Sshh, remember these websites on tables?
		...
		final JMenuItem mntmJava = new JMenuItem("Java"); // https://xkcd.com/801/
		final JMenuItem mntmJshintrc = new JMenuItem("JSON with C++ style comments");
		final JMenuItem mntmJson = new JMenuItem("JSON");
		final JMenuItem mntmJsp = new JMenuItem("JSP"); // Trying to learn this one, feeling like it's useless.
		final JMenu mnL = new JMenu("L");
		final JMenuItem mntmLatex = new JMenuItem("Latex"); // Pretty hard for me.
		final JMenuItem mntmLess = new JMenuItem("Less");
		final JMenuItem mntmLisp = new JMenuItem("Lisp"); // Yay, raw AST!
		...
		final JMenuItem mntmPerl = new JMenuItem("Perl"); // Still worse than Ruby
		...
		final JMenuItem mntmRuby = new JMenuItem("Ruby"); // Still better than Perl
		final JMenu mnS = new JMenu("S");
		final JMenuItem mntmSas = new JMenuItem("SAS");
		final JMenuItem mntmSacala = new JMenuItem("Scala");
		final JMenuItem mntmSql = new JMenuItem("SQL"); // Look at TCL
