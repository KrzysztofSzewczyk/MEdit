...
public class UIUtil {
	 ...
	 *
	 * @param uri
	 *            The URI to open. If this is <code>null</code>, nothing happens and
	...
	/**
	 * Fixes the orientation of the renderer of a combo box. I can't believe Swing
	...
	/**
	 * Returns an empty border of width 5 on all sides. Since this is a very common
	 * border in GUI's, the border returned is a singleton.
	 *
	 * @return The border.
	 */
	...
	/**
	 * Returns a color to use for "error" text in a text field. This will pick red
	 * for dark-text-on-light-background LookAndFeels, and a brighter color for
	 * light-text-on-dark-background LookAndFeels.
	 *
	 ...
	 * @param cols
	 *            The number of columns of components to make.
	 * @param initialX
	...
	/**
	 * Returns a button with the specified text. If another property with name
	 * <code>getString(textKey) + ".Mnemonic"</code> is defined, it is used as the
	 * mnemonic for the button.
	 *
	 * @param bundle
	 *            The resource bundle in which to get the int.
	 * @param key
	...
	/**
	 * Returns an <code>JLabel</code> with the specified text. If another property
	 * with name <code>getString(textKey) + ".Mnemonic"</code> is defined, it is
