 ...
 * (as <code>JComboBox</code>'s do by default).<br>
 * <br>
...
public class RComboBoxModel extends DefaultComboBoxModel {
	...
	/**
	 * Adds an item at a specified index. The implementation of this method should
	 * notify all registered <code>ListDataListeners</code> that the item has been
	 * added.
	 *
	 * @param anObject
	 ...
	 *
	 * @param numElements
	 *            The maximum number of items this combo box can hold. If
