...
public interface CompletionProvider {
	 ...
	 *
	 * @param listStart
	 *            The character that marks the beginning of a list of parameters,
	 *            such as '<tt>(</tt>' in C or Java.
	 * @param separator
	 *            Text that should separate parameters in a parameter list when one
	 *            is inserted. For example, "<tt>, </tt>".
	 * @param listEnd
	 *            The character that marks the end of a list of parameters, such as
	 *            '<tt>)</tt>' in C or Java.
	 * @throws IllegalArgumentException
	 *             If either <tt>listStart</tt> or <tt>listEnd</tt> is not printable
	 *             ASCII, or if <tt>separator</tt> is <code>null</code> or an empty
	 *             string.
	 ...
	 *
	 * @param parent
	 *            The parent provider. <code>null</code> means there will be no
	 *            parent provider.
	 * @see #getParent()
	 */
