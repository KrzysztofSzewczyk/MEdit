...
public class StaticCodeTemplate extends AbstractCodeTemplate {
	...
	public void invoke(final RSyntaxTextArea textArea) throws BadLocationException {
		...
		final int p1 = Math.max(dot, mark);
	...
	public void setAfterCaretText(final String afterCaret) {
		this.afterCaret = afterCaret == null ? StaticCodeTemplate.EMPTY_STRING : afterCaret;
	...
	public void setBeforeCaretText(final String beforeCaret) {
		this.beforeCaret = beforeCaret == null ? StaticCodeTemplate.EMPTY_STRING : beforeCaret;
	...
	public String toString() {
		return "[StaticCodeTemplate: id=" + this.getID() + ", text=" + this.getBeforeCaretText() + "|"
				+ this.getAfterCaretText() + "]";
	}
