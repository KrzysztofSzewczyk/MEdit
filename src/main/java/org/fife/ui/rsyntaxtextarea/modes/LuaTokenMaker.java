...
public class LuaTokenMaker extends AbstractJFlexTokenMaker {
	 ...
	 */
	private static final char[] ZZ_CMAP = LuaTokenMaker.zzUnpackCMap(LuaTokenMaker.ZZ_CMAP_PACKED);
	...
	private static int[] zzUnpackAction() {
		final int[] result = new int[201];
		int offset = 0;
		offset = LuaTokenMaker.zzUnpackAction(LuaTokenMaker.ZZ_ACTION_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackAttribute() {
		final int[] result = new int[201];
		int offset = 0;
		offset = LuaTokenMaker.zzUnpackAttribute(LuaTokenMaker.ZZ_ATTRIBUTE_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackRowMap() {
		final int[] result = new int[201];
		int offset = 0;
		offset = LuaTokenMaker.zzUnpackRowMap(LuaTokenMaker.ZZ_ROWMAP_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackTrans() {
		final int[] result = new int[9720];
		int offset = 0;
		offset = LuaTokenMaker.zzUnpackTrans(LuaTokenMaker.ZZ_TRANS_PACKED_0, offset, result);
		return result;
	}
	...
	private int zzLexicalState = LuaTokenMaker.YYINITIAL;
	 ...
	 */
	public LuaTokenMaker(final java.io.InputStream in) {
	 ...
	 */
	public LuaTokenMaker(final java.io.Reader in) {
		this.zzReader = in;
	}
	...
	public Token getTokenList(final Segment text, final int initialTokenType, final int startOffset) {
		...
		case TokenTypes.COMMENT_MULTILINE:
			state = LuaTokenMaker.MLC;
			this.start = text.offset;
			break;
		case TokenTypes.LITERAL_STRING_DOUBLE_QUOTE:
			state = LuaTokenMaker.LONGSTRING;
			this.start = text.offset;
			break;
		default:
	...
	public org.fife.ui.rsyntaxtextarea.Token yylex() throws java.io.IOException {
		...
		final char[] zzCMapL = LuaTokenMaker.ZZ_CMAP;

		final int[] zzTransL = LuaTokenMaker.ZZ_TRANS;
		final int[] zzRowMapL = LuaTokenMaker.ZZ_ROWMAP;
		final int[] zzAttrL = LuaTokenMaker.ZZ_ATTRIBUTE;
		...
		while (true) {
			...
			switch (zzAction < 0 ? zzAction : LuaTokenMaker.ZZ_ACTION[zzAction]) {
			case 3: {
				this.addNullToken();
			...
			case 15: {
				...
				this.yybegin(LuaTokenMaker.LONGSTRING);
			}
			case 26:
				break;
			case 19: {
				this.yybegin(LuaTokenMaker.YYINITIAL);
			...
			case 21: {
				...
				this.yybegin(LuaTokenMaker.MLC);
			}
			case 31:
				break;
			case 7: {
			...
			case 16: {
				this.start = this.zzMarkedPos - 2;
				this.yybegin(LuaTokenMaker.LINECOMMENT);
			}
			case 44:
				break;
			case 9: {
			...
			case 46:
				break;
			default:
				if (zzInput == LuaTokenMaker.YYEOF && this.zzStartRead == this.zzCurrentPos) {
					this.zzAtEOF = true;
					...
					this.zzScanError(LuaTokenMaker.ZZ_NO_MATCH);
			}
		}
	}
	...
	public void yypushback(final int number) {
		if (number > this.yylength())
			this.zzScanError(LuaTokenMaker.ZZ_PUSHBACK_2BIG);
	...
	public final void yyreset(final Reader reader) {
		...
		this.zzLexicalState = LuaTokenMaker.YYINITIAL;
	...
	private void zzScanError(final int errorCode) {
		String message;
		try {
			message = LuaTokenMaker.ZZ_ERROR_MSG[errorCode];
		} catch (final ArrayIndexOutOfBoundsException e) {
			message = LuaTokenMaker.ZZ_ERROR_MSG[LuaTokenMaker.ZZ_UNKNOWN_ERROR];
		}
