...
public class DockerTokenMaker extends AbstractJFlexTokenMaker {
	 ...
	 */
	private static final char[] ZZ_CMAP = DockerTokenMaker.zzUnpackCMap(DockerTokenMaker.ZZ_CMAP_PACKED);
	...
	private static int[] zzUnpackAction() {
		...
		int offset = 0;
		offset = DockerTokenMaker.zzUnpackAction(DockerTokenMaker.ZZ_ACTION_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackAttribute() {
		final int[] result = new int[84];
		int offset = 0;
		offset = DockerTokenMaker.zzUnpackAttribute(DockerTokenMaker.ZZ_ATTRIBUTE_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackRowMap() {
		final int[] result = new int[84];
		int offset = 0;
		offset = DockerTokenMaker.zzUnpackRowMap(DockerTokenMaker.ZZ_ROWMAP_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackTrans() {
		...
		int offset = 0;
		offset = DockerTokenMaker.zzUnpackTrans(DockerTokenMaker.ZZ_TRANS_PACKED_0, offset, result);
		return result;
	}
	...
	private int zzLexicalState = DockerTokenMaker.YYINITIAL;
	 ...
	 */
	public DockerTokenMaker(final java.io.InputStream in) {
	 ...
	 */
	public DockerTokenMaker(final java.io.Reader in) {
		this.zzReader = in;
	}
	...
	public org.fife.ui.rsyntaxtextarea.Token yylex() throws java.io.IOException {
		...
		while (true) {
			...
			zzForAction: {
				while (true) {
					...
					if (zzCurrentPosL < zzEndReadL)
						...
						zzInput = DockerTokenMaker.YYEOF;
						break zzForAction;
					} else {
			...
			case 5: {
				...
				this.yybegin(DockerTokenMaker.STRING);
			}
			case 26:
				break;
			case 13: {
				this.yybegin(DockerTokenMaker.YYINITIAL);
			...
			case 6: {
				this.start = this.zzMarkedPos - 1;
				this.yybegin(DockerTokenMaker.CHAR_LITERAL);
			}
			case 32:
				break;
			default:
				if (zzInput == DockerTokenMaker.YYEOF && this.zzStartRead == this.zzCurrentPos) {
					this.zzAtEOF = true;
					...
					this.zzScanError(DockerTokenMaker.ZZ_NO_MATCH);
			}
		}
	}
	...
	public void yypushback(final int number) {
		if (number > this.yylength())
			this.zzScanError(DockerTokenMaker.ZZ_PUSHBACK_2BIG);
	...
	public final void yyreset(final Reader reader) {
		...
		this.zzLexicalState = DockerTokenMaker.YYINITIAL;
	...
	private void zzScanError(final int errorCode) {
		...
		try {
			...
			message = DockerTokenMaker.ZZ_ERROR_MSG[DockerTokenMaker.ZZ_UNKNOWN_ERROR];
		}
