...
public class HostsTokenMaker extends AbstractJFlexTokenMaker {
	 ...
	 */
	private static final char[] ZZ_CMAP = HostsTokenMaker.zzUnpackCMap(HostsTokenMaker.ZZ_CMAP_PACKED);
	...
	private static int[] zzUnpackAction() {
		...
		int offset = 0;
		offset = HostsTokenMaker.zzUnpackAction(HostsTokenMaker.ZZ_ACTION_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackAttribute() {
		final int[] result = new int[24];
		int offset = 0;
		offset = HostsTokenMaker.zzUnpackAttribute(HostsTokenMaker.ZZ_ATTRIBUTE_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackRowMap() {
		final int[] result = new int[24];
		int offset = 0;
		offset = HostsTokenMaker.zzUnpackRowMap(HostsTokenMaker.ZZ_ROWMAP_PACKED_0, offset, result);
		return result;
	}
	...
	private static int[] zzUnpackTrans() {
		...
		int offset = 0;
		offset = HostsTokenMaker.zzUnpackTrans(HostsTokenMaker.ZZ_TRANS_PACKED_0, offset, result);
		return result;
	}
	...
	private int zzLexicalState = HostsTokenMaker.YYINITIAL;
	 ...
	 */
	public HostsTokenMaker(final java.io.InputStream in) {
	 ...
	 */
	public HostsTokenMaker(final java.io.Reader in) {
		this.zzReader = in;
	}
	...
	public Token getTokenList(final Segment text, final int initialTokenType, final int startOffset) {
		...
		final int state = HostsTokenMaker.YYINITIAL;
	...
	public org.fife.ui.rsyntaxtextarea.Token yylex() throws java.io.IOException {
		...
		while (true) {
			...
			case 4: {
				...
				this.yybegin(HostsTokenMaker.EOL_COMMENT);
			}
			case 10:
				break;
			case 3: {
			...
			case 12:
				break;
			case 1: {
				this.addToken(this.first ? TokenTypes.RESERVED_WORD : TokenTypes.IDENTIFIER);
				this.first = false;
			}
			case 13:
				break;
			...
			case 14:
				break;
			default:
				if (zzInput == HostsTokenMaker.YYEOF && this.zzStartRead == this.zzCurrentPos) {
					this.zzAtEOF = true;
					...
					this.zzScanError(HostsTokenMaker.ZZ_NO_MATCH);
			}
		}
	}
	...
	public void yypushback(final int number) {
		if (number > this.yylength())
			this.zzScanError(HostsTokenMaker.ZZ_PUSHBACK_2BIG);
	...
	public final void yyreset(final java.io.Reader reader) {
		...
		this.zzLexicalState = HostsTokenMaker.YYINITIAL;
	...
	private void zzScanError(final int errorCode) {
		...
		try {
			...
			message = HostsTokenMaker.ZZ_ERROR_MSG[HostsTokenMaker.ZZ_UNKNOWN_ERROR];
		}
