...
public interface Token extends TokenTypes {
	 ...
	 * @param fontFamily
	 *            Whether to include the font family in the HTML for this token. You
	 *            can pass <code>false</code> for this parameter if, for example,
	 *            you are making all your HTML be monospaced, and don't want any
	 *            crazy fonts being used in the editor to be reflected in your HTML.
	 ...
	 *            How to expand tabs.
	 * @param startX
	 *            The x-coordinate at which the token will be painted. This is
	 *            needed because of tabs.
	 * @param endBeforeX
	 *            The x-coordinate for which you want to find the last character of
	 *            <code>t</code> which comes before it.
	 ...
	 *            How to expand tabs.
	 * @param pos
	 *            The position in the document for which to get the bounding box in
	 *            the view.
	 * @param x0
	 *            The pixel x-location that is the beginning of
	 *            <code>tokenList</code>.
	 * @param rect
	 *            The rectangle in which we'll be returning the results. This object
	 *            is reused to keep from frequent memory allocations.
