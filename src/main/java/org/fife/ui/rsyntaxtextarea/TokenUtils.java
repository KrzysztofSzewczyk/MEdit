...
public final class TokenUtils {
	 ...
	 *
	 * @param tokenList
	 *            The list to make start at the specified position. This parameter
	 *            is modified.
	 * @param pos
	 *            The position at which the new token list is to start. If this
	 ...
	 *      TokenImpl)
	 */
	public static TokenSubList getSubTokenList(final Token tokenList, final int pos, final TabExpander e,
			final RSyntaxTextArea textArea, final float x0) {
	 ...
	 *            The initial x-pixel position of the old token list.
	 * @param tempToken
	 *            A temporary token to use when creating the token list result. This
	 *            may be <code>null</code> but callers can pass in a "buffer" token
	 ...
	 */
	public static TokenSubList getSubTokenList(final Token tokenList, final int pos, final TabExpander e,
			final RSyntaxTextArea textArea, float x0, TokenImpl tempToken) {
