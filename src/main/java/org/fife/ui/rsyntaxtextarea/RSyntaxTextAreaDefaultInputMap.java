...
public class RSyntaxTextAreaDefaultInputMap extends RTADefaultInputMap {
	...
	public RSyntaxTextAreaDefaultInputMap() {
		...
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_TAB, shift), RSyntaxTextAreaEditorKit.rstaDecreaseIndentAction);
		this.put(KeyStroke.getKeyStroke('}'), RSyntaxTextAreaEditorKit.rstaCloseCurlyBraceAction);

		this.put(KeyStroke.getKeyStroke('/'), RSyntaxTextAreaEditorKit.rstaCloseMarkupTagAction);
		...
		if (os == RSyntaxUtilities.OS_WINDOWS || os == RSyntaxUtilities.OS_MAC_OSX)
			...
			this.put(KeyStroke.getKeyStroke(KeyEvent.VK_SLASH, defaultMod),
					RSyntaxTextAreaEditorKit.rstaToggleCommentAction);

		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_OPEN_BRACKET, defaultMod),
				RSyntaxTextAreaEditorKit.rstaGoToMatchingBracketAction);
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_SUBTRACT, defaultMod),
				RSyntaxTextAreaEditorKit.rstaCollapseFoldAction);
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_ADD, defaultMod), RSyntaxTextAreaEditorKit.rstaExpandFoldAction);
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_DIVIDE, defaultMod),
				RSyntaxTextAreaEditorKit.rstaCollapseAllFoldsAction);
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_MULTIPLY, defaultMod),
		...
		this.put(KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, defaultShift),
				RSyntaxTextAreaEditorKit.rstaPossiblyInsertTemplateAction);
