...
public abstract class RecordableTextAction extends TextAction {
	 ...
	 */
	public RecordableTextAction(final String text, final Icon icon, final String desc, final Integer mnemonic,
	...
	public int getMnemonic() {
		final Integer i = (Integer) this.getValue(Action.MNEMONIC_KEY);
	 ...
	 *            The resource bundle.
	 * @param keyRoot
	 *            The root of the keys for the properties. "<code>.Name</code>",
	 ...
	 *
	 * @param recordable
	 *            Whether or not this action should be recorded and replayed.
	 * @see #isRecordable()
	 */
	...
	public void setShortDescription(final String shortDesc) {
		this.putValue(Action.SHORT_DESCRIPTION, shortDesc);
	}
