...
public abstract class ImageBackgroundPainterStrategy implements BackgroundPainterStrategy {
	...
	private final RTextAreaBase textArea;
	...
	public ImageBackgroundPainterStrategy(final RTextAreaBase textArea) {
		...
		this.scalingHint = Image.SCALE_FAST;
	}
	 ...
	 * @param bounds
	 *            The bounds in which to paint the image. The image will be scaled
	 *            to fit exactly in these bounds if necessary.
	 */
	@Override
	...
	public void setImage(final Image image) {
		this.master = image;
		this.oldWidth = -1; // To trick us into fixing bgImage.
	}
