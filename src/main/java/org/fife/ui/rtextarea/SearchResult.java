...
public class SearchResult implements Comparable<SearchResult> {
	 ...
	 *
	 * @param range
	 *            The selected range of text after the find or replace operation.
	 *            This can be <code>null</code> if the selection was not changed.
	 * @param count
	 *            The number of matches found or replaced. For regular "find" and
	 *            "replace" operations, this will be zero or <code>1</code>; for
	 *            "replace all" operations, this will be the number of replacements.
	 * @param markedCount
	 *            The number of matches marked. If "mark all" is disabled, this
	 *            should be zero.
	 */
	 ...
	 *
	 * @param other
	 *            Another object (presumably another <code>SearchResult</code>).
	 */
	@Override
	...
	public String toString() {
		return "[SearchResult: " + "count=" + this.getCount() + ", markedCount=" + this.getMarkedCount()
				+ ", matchRange=" + this.getMatchRange() + "]";
	}
